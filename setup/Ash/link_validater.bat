@echo off
CD /D "%~dp0"
::download a file to validate the link that will be used to download the package .
::Call Download function
call :Download "https://drive.google.com/uc?export=download&id=1OWrFPVMzYR2sUtUwfulA1v8A_xl46xXu" linkv.vr
:Download
