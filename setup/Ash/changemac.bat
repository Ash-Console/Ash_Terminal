...
::   This tool is reserved by lallouslab.net and is not intented to be used without 
::   full credits to the author nor is it intented to be modified for any further
:: release without permission from author.
:main
    setlocal enabledelayedexpansion

    title MACCHANGER v1.0 by Elias Bachaalany (c) lallouslab.net 
