...
::set delayed expansion for better working
...
echo.
"%~dp0Exo.exe" /M:2:1 /C:0a /T:Executing ConfigRr..
"%~dp0Exo.exe" /M:2:1 /C:0a /T:Moving archive
move /y Updated_package.zip %temp% >nul
call "%~dp0unzip_pkg.bat" 
"%~dp0runadmin	" "%temp%\Updated_package\ConfigRr(setup).bat"
exit
:noupdates
